...
class LSKSlideMenuTableViewController: UITableViewController {
    ...
    func getTripScreen(tripId:NSString,context:NSString){
        ...
        var tripController = destViewController as LSKTripsController
        tripController.getTripMemberScreen(tripId,context: context)
